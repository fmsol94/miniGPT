...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.sa_heads = MultiHeadAttention(4, n_embd//4) # 4 heads of 8-dimensional self-attention. It will be concatenated into a 32-dimensional array, same as n_embd
